...
import SidebarButtonSheet from './SidebarButtonSheet';
            ...
            <Drawer>
              ...
              <DrawerContent className='mb-2 p-2'>
                <div className='flex flex-col space-y-2 mt-2'>
                  <Link href='/'>
                    <SidebarButtonSheet size='sm' icon={Settings} className='w-full'>
                      Account Settings
                    </SidebarButtonSheet>
                  </Link>
                  <SidebarButtonSheet size='sm' icon={LogOut} className='w-full'>
                    Log Out
                  </SidebarButtonSheet>
                </div>
              </DrawerContent>
